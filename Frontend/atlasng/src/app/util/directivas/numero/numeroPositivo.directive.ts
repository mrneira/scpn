...
export const CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NumeroPositivoDirective),
  multi: true
};

@Directive({
  selector: "input[numeroPositivo]",
  providers: [CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR]
})
export class NumeroPositivoDirective implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit {
