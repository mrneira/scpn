...
export const CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NumeroDecimal22Directive),
  multi: true
};

@Directive({
  selector: "input[numeroDecimal22]",
  providers: [CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR]
})
export class NumeroDecimal22Directive implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit {
