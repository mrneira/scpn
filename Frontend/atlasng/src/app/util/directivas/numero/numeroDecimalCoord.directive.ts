...
export const CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NumeroDecimalCoordDirective),
  multi: true
};

@Directive({
  selector: "input[numeroDecimalCoord]",
  providers: [CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR]
})
export class NumeroDecimalCoordDirective implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit {
