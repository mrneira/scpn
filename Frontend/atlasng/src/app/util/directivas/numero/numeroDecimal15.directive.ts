...
export const CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NumeroDecimal15Directive),
  multi: true
};

@Directive({
  selector: "input[numeroDecimal15]",
  providers: [CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR]
})
export class NumeroDecimal15Directive implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit {
