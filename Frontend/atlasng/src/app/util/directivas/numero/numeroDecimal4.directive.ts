...
export const CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NumeroDecimal4Directive),
  multi: true
};

@Directive({
  selector: "input[numeroDecimal4]",
  providers: [CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR]
})
export class NumeroDecimal4Directive implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit {
