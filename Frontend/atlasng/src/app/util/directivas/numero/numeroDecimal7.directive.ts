...
export const CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NumeroDecimal7Directive),
  multi: true
};

@Directive({
  selector: "input[numeroDecimal7]",
  providers: [CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR]
})
export class NumeroDecimal7Directive implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit {
