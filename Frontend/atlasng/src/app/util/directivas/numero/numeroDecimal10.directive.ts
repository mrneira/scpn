...
export const CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NumeroDecimal10Directive),
  multi: true
};

@Directive({
  selector: "input[numeroDecimal10]",
  providers: [CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR]
})
export class NumeroDecimal10Directive implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit {
