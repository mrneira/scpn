...
export const CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR: any = {
  ...
  useExisting: forwardRef(() => NumeroDecimal11Directive),
  multi: true
};

@Directive({
  selector: "input[numeroDecimal11]",
  providers: [CURRENCYMASKDIRECTIVE_VALUE_ACCESSOR]
})
export class NumeroDecimal11Directive implements AfterViewInit, ControlValueAccessor, DoCheck, OnInit {
