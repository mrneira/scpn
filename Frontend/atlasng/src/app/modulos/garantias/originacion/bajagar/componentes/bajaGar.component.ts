...
@Component({
  ...
  templateUrl: 'bajaGar.html'
})
export class BajaGarComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    ...
    this.datosGeneralesComponent.formvalidado = true;

    this.datosGeneralesComponent.operaciongar.formeditable = false;
    this.datosGeneralesComponent.operaciongar.formvalidado = true;

    this.avaluo.formeditable = false;
    this.avaluo.formvalidado = true;
  }
  ...
  public postCommit(resp: any) {
    ...
    if (resp.cod === 'OK') {
      this.mcampos.coperacion = this.garComponent.registro.pk;
      this.coperacion = this.garComponent.registro.pk;
    }
  }
