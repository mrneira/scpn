...
export class InscripcionComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public crearDtoConsulta(): Consulta {
    ...
    consulta.addSubquery('TgenPais', 'nombre', 'npais', 'i.pk = t.cpais');
    consulta.addSubquery('TgenProvincia', 'nombre', 'nprovincia', 'i.pk.cpais = t.cpais and i.pk.cpprovincia=t.cpprovincia');
    consulta.addSubquery('TgenCanton', 'nombre', 'ncanton', 'i.pk.cpais = t.cpais and i.pk.cpprovincia=t.cpprovincia and i.pk.ccanton=t.ccanton');
  ...
  fijarLovPaisesSelec(reg: any): void {
    if (reg.registro !== undefined) {
      this.registro.cpais = reg.registro.pk;
  ...
  mostrarLovProvincias(): void {
    ...
    this.lovProvincias.mfiltros.pk_cpais = this.registro.cpais;
  ...
  fijarLovProvinciasSelec(reg: any): void {
    if (reg.registro !== undefined) {
      this.registro.cpprovincia = reg.registro.pk.cpprovincia;
  ...
  mostrarLovCantones(): void {
    ...
    this.lovCantones.mfiltros.pk_cpais = this.registro.cpais;
    this.lovCantones.mfiltros.pk_cpprovincia = this.registro.cpprovincia;
  ...
  fijarLovCantonesSelec(reg: any): void {
    if (reg.registro !== undefined) {
      this.registro.ccanton = reg.registro.pk.ccanton;
