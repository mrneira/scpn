...
import { InscripcionComponent } from '../submodulos/inscripcion/componentes/_inscripcion.component';

@Component({
  selector: 'app-solicitud-ingreso',
  templateUrl: 'inscripcionGar.html'
})
export class InscripcionGarComponent extends BaseComponent implements OnInit, AfterViewInit {
