...
import { AvaluoComponent } from '../../ingresoreaval/submodulos/avaluo/componentes/_avaluo.component';
import { LovOperacionGarComponent } from '../../../lov/operacion/componentes/lov.operacionGar.component';

@Component({
  selector: 'app-solicitud-ingreso',
  templateUrl: 'ingresoReAval.html'
})
export class IngresoReAvalComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  grabar(): void {
    this.rqMantenimiento.mdatos.valoravaluo = this.avaluo.registro.valoravaluo;
