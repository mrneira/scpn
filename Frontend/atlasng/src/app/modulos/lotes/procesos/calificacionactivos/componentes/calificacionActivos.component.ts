...
@Component({
  selector: 'app-calificacion-activos',
  templateUrl: 'calificacionActivos.html'
})
export class CalificacionActivosComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  inicializar() {
    ...
    this.mcampos.ntransaccion = 'CALIFICACION DE ACTIVOS';
    this.mfiltros.clote = 'CALIFICACION-CARTERA';
    this.consultar();
  }
}
