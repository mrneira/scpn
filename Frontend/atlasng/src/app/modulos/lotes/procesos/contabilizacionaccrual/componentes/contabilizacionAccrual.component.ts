...
@Component({
  ...
  templateUrl: 'contabilizacionAccrual.html'
})
export class ContabilizacionAccrualComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.mcampos.ntransaccion = 'CONTABILIZACION ACCRUAL';
    this.mfiltros.clote = 'CONTABILIZACION';
    this.consultar();
  }
