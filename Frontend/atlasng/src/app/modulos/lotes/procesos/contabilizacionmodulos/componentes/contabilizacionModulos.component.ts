...
@Component({
  selector: 'app-contabilizacion-accrual',
  templateUrl: 'contabilizacionModulos.html'
})
export class ContabilizacionModulosComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.mcampos.ntransaccion = 'CONTABILIZACION MODULOS';
    this.mfiltros.clote = 'COMPROBANTES-CONTABLE-MODULOS';
    this.consultar();
  }
