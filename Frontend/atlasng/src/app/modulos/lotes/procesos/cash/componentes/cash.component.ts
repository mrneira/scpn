...
export class CashComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.mcampos.ntransaccion = 'RECAUDACIÓN CASH';
  ...
  private fijarFiltrosConsulta() {
    this.mfiltros.clote = 'RECAUDACIONCASH';
  }
