...
@Component({
  selector: 'app-inicio-dia',
  templateUrl: 'inicioDia.html'
})
export class InicioDiaComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.mcampos.ntransaccion = 'INICIO DE DIA';
    this.mfiltros.clote = 'INICIODIA';
    this.consultar();
  }
