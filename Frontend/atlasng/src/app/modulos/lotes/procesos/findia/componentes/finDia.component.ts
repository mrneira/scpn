...
@Component({
  ...
  templateUrl: 'finDia.html'
})
export class FinDiaComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.mcampos.ntransaccion = 'FIN DE DIA';
    this.mfiltros.clote = 'FINDIA';
    this.consultar();
  }
