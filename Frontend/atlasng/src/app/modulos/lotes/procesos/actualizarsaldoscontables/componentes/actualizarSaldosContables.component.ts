...
@Component({
  selector: 'app-actualizar-saldos-contables',
  templateUrl: 'actualizarSaldosContables.html'
})
export class ActualizarSaldosContablesComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.mcampos.ntransaccion = 'ACTUALIZAR SALDOS CONTABLES';
    this.mfiltros.clote = 'SALDOCONTABLE';
    this.consultar();
  }
