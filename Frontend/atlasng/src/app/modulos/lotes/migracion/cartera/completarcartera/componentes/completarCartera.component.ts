...
@Component({
  selector: 'app-completar-cartera',
  templateUrl: 'completarCartera.html'
})
export class CompletarCarteraComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.mcampos.ntransaccion = 'MIGRACIÓN';
    this.consultar();
  }
