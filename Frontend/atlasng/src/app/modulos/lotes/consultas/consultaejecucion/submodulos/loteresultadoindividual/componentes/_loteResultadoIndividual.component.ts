...
@Component({
  selector: 'app-lote-resultado-individual',
  templateUrl: '_loteResultadoIndividual.html'
})
export class LoteResultadoIndividualComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {// ya estan definidos los alias
    super(router, dtoServicios, 'TloteResultadoIndividual', 'LOTEINDIVIDUAL', false, true); // true cuendo es pk compuesto
  ...
  public crearDtoConsulta(): Consulta {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.freal desc, t.cidentificador', this.mfiltros, this.mfiltrosesp);
  ...
  public fijarFiltrosConsulta() {
    // this.mfiltros.pk_clote = this.lote;
  }
