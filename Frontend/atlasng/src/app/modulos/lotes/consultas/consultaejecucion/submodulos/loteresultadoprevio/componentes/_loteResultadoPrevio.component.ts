...
@Component({
  selector: 'app-lote-resultado-previo',
  templateUrl: '_loteResultadoPrevio.html'
})
export class LoteResultadoPrevioComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {// ya estan definidos los alias
    super(router, dtoServicios, 'TloteResultadoPrevio', 'LOTEPREVIO', false, true); // true cuendo es pk compuesto
  ...
  public crearDtoConsulta(): Consulta {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.finicio asc', this.mfiltros, this.mfiltrosesp);
