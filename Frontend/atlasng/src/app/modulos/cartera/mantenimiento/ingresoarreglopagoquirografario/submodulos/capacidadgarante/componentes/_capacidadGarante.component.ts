...
@Component({
  selector: 'app-capacidad-garante',
  templateUrl: '_capacidadGarante.html'
})
export class CapacidadGaranteComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  egresosComponent: EgresosCapacidadComponent;

  @ViewChild(IngresosCapacidadComponent)
  ingresosComponent: IngresosCapacidadComponent;
