...
@Component({
  selector: 'app-lov-requisitos',
  templateUrl: 'lov.requisitos.html'
})
export class LovRequisitosComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TcarRequisitos', 'LOVREQUISITOS', false, true);
  }
