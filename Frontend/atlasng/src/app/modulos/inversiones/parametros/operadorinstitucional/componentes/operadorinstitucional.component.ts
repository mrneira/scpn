...
@Component({
  selector: 'app-operadorinstitucional',
  templateUrl: 'operadorinstitucional.html'
})
export class OperadorinstitucionalComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public crearDtoConsulta(): Consulta {
    ...
    this.mfiltros.bancoccatalogo = 1224;
