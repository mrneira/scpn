...
@Component({
  selector: 'app-contabilidadbancos',
  templateUrl: 'contabilidadbancos.html'
})
export class ContabilidadbancosComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tinvplantillacontable', 'CONTABILIDADBANCOS', false, false);
  ...
  actualizar() {
    ...
    if (!this.estaVacio(this.registro.rubrocdetalle)) {
      this.registro.entidadccatalogo = 1224;
    }
    else {
  ...
  public crearDtoConsulta(): Consulta {
    ...
    this.mfiltrosesp.rubrocdetalle = " in ('BANCOS') ";
  ...
  llenarConsultaCatalogos(): void {
    ...
    const mfiltrosparam = { 'ccatalogo': 'in (1224)' };
    ...
    const mfiltrosEspRubro = { "cdetalle": " in ('BANCOS') " };
