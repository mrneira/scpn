...
@Component({
  ...
  templateUrl: 'dividendos.html'
})
export class DividendosComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptInvDividendos';
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Inversiones/rptInvDividendos';
