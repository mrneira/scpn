...
export class AlertasComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, '', 'ALERTAS', false);
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptInvAlertas';
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Inversiones/rptInvAlertas';
