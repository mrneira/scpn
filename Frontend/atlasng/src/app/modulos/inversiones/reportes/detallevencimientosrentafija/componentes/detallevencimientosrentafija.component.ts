...
@Component({
  selector: 'app-detallevencimientosrentafija',
  templateUrl: 'detallevencimientosrentafija.html'
})
export class DetallevencimientosrentafijaComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, '', 'detallevencimientosrentafija', false);
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptInvdetallevencimientosrentafija';
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Inversiones/rptInvdetallevencimientosrentafija';
