...
@Component({
  ...
  templateUrl: 'rendimientorentafija.html'
})
export class RendimientorentaFijaComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  imprimir(reg: any): void {
    ...
    this.jasper.nombreArchivo = 'RendimientoRentaFija';
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Inversiones/rptInvRendimientoRentaFija';
