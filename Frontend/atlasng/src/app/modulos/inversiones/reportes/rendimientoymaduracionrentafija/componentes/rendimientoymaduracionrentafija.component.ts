...
export class RendimientoMaduracionRentaFija extends BaseComponent implements OnInit, AfterViewInit {
  ...
  llenarConsultaCatalogos(): void {
        ...
        this.mfiltrosesp.cdetalle = "  not in ('ACCION','ACCOPP','CAJA') ";

        const consultaInstrumento = new Consulta('tgencatalogodetalle', 'Y', 't.nombre', mfiltrosInstrumento, this.mfiltrosesp);
