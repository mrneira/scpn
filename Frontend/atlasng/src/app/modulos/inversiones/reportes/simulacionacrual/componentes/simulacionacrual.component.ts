...
@Component({
  selector: 'app-simulacionacrual',
  templateUrl: 'simulacionacrual.html'
})
export class SimulacionAcrualComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptInvSimulacionAcrual';
    ...
    this.jasper.parametros['@i_fcontabledesde'] = lffin;

    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Inversiones/rptInvSimulacionAcrual';
