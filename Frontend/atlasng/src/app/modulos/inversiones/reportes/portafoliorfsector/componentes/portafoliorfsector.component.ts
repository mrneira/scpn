...
@Component({
  selector: 'app-portafoliorfsector',
  templateUrl: 'portafoliorfsector.html'
})
export class PortafoliorfsectorComponent extends BaseComponent implements OnInit, AfterViewInit {

  @ViewChild(JasperComponent)
  public jasper: JasperComponent;

  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, '', 'PORTAFOLIORFSEC', false);
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptInvPortafolioRentaFijaSector';
