...
@Component({
  ...
  templateUrl: 'operativoContableRentVar.html'
})
export class OperativoContableRentVarComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    this.mblnOperativoContable = (sessionStorage.getItem('t') === "99");//CCA cambios 20210324
  ...
  consultar() {
    ...
    if (this.estaVacio(this.mcampos.rubrocdetalle)) {
      ...
      return;
    }*/ // CCA cambios 20210324

    this.fijarFiltrosConsulta();
    this.rqConsulta.mdatos.CODIGOCONSULTA = 'INVSALDOOPERATIVO';
    this.rqConsulta.storeprocedure = "sp_InvConSaldosContablesRVar";// CCA cambios 20210324
    super.consultar();
  }
  ...
  private fijarFiltrosConsulta() {
    ...
    this.rqConsulta.parametro_i_rubrocdetalle = "CAP";// CCA cambios 20210324
  }
  ...
  consultaDetalleOperativo(registro: any) {
    ...
    if (this.mblnOperativoContable) {
      this.rqConsulta.storeprocedure = "sp_InvDetalleOperativoInversion"; // CCA cambios 20210324
    }
    /*else {
  ...
  imprimir(resp: any): void {
    //if (this.estaVacio(this.mcampos.csaldo)) {
      ...
      this.jasper.parametros['@i_csaldo'] = "CAP";// CCA cambios 
      this.jasper.parametros['@i_nsaldo'] = "Capital";// CCA cambios 20210324
      this.jasper.parametros['@i_rubrocdetalle'] = "CAP";// CCA cambios 20210324
      this.jasper.nombreArchivo = 'OperativoContableRentVar';// CCA cambios 20210324
      this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Prestamos/rptInvConsultaOperativoContableRentaVariable';// CCA cambios 20210324
