...
export class PagomoraComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public crearDtoConsulta(): Consulta {
    ...
    consulta.addSubquery('tinvtablaamortizacion', 'comentariomoraing', 'nComentarioIngreso', 'i.cinvtablaamortizacion = t.cinvtablaamortizacion');
  ...
  edit(row: any, index: number) {
    ...
    this.mCapital = row.proyeccioncapital;
