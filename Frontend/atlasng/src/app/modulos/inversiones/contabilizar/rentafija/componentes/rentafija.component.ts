...
export class RentafijaComponent extends BaseComponent
  ...
  consultar() {
    ...
    this.tablamortizacionComponent.mfiltros.cinversion = this.mcampos.cinversion;
    this.tablamortizacionComponent.consultar();
  ...
  obtenerInversion() {
    ...
    this.dtoServicios.ejecutarConsultaRest(rqConsulta)
      ...
      resp => {
        ...
        this.instrumentoComponent.registro.fcompra = lregistro[0].nfcompra;
        ...
        this.instrumentoComponent.registro.calificacionriesgoactualcdetalle = lregistro[0].calificacionriesgoactualcdetalle;
        ...
        this.instrumentoComponent.registro.bancopagocdetalle = lregistro[0].bancopagocdetalle;
        ...
        this.instrumentoComponent.calcularFechaVencimiento();
        this.instrumentoComponent.totalizaComisiones();
        this.instrumentoComponent.completaIntereses(this.instrumentoComponent.registro.interestranscurridodias);
