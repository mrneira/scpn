...
export class InstrumentoComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  mostrarLovCuentasContables(): void {
    this.lCuentaContable = 1;
    this.lovCuentasContables.showDialog(true); // con true solo muestra cuentas de movimiento.
  }

  mostrarLovCuentasContablesBanco(): void {
    this.lCuentaContable = 2;
    this.lovCuentasContablesBanco.showDialog(true); // con true solo muestra cuentas de movimiento.
  }
