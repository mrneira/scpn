...
@Component({
  selector: 'app-catalogopatrimonio',
  templateUrl: 'catalogopatrimonio.html'
})

export class CatalogopatrimonioComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tconcatalagopatrimonio', 'CatalogoPatrimonio', false, true);
  ...
  public crearDtoConsulta(): Consulta {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.ccatalogopatrimonio', this.mfiltros, this.mfiltrosesp);
