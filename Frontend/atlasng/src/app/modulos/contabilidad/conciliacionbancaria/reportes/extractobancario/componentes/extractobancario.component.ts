...
@Component({
  selector: 'app-extractobancario',
  templateUrl: 'extractobancario.html'
})
export class ExtractobancarioComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  imprimir(resp: any): void {
    ...
    if ((this.mcampos.finicio != null && this.mcampos.ffin == null) || (this.mcampos.finicio == null && this.mcampos.ffin != null) || (this.mcampos.finicio > this.mcampos.ffin)) {
      ...
      this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Contabilidad/rptConExtractoBancario';
