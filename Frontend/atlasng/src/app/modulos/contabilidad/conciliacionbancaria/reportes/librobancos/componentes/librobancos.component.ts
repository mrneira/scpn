...
@Component({
  selector: 'app-librobancos',
  templateUrl: 'librobancos.html'
})
export class LibrobancosComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptConConciliacionLibroBancos';
    ...
    if ((this.mcampos.finicio != null && this.mcampos.ffin == null) || (this.mcampos.finicio == null && this.mcampos.ffin != null) || (this.mcampos.finicio > this.mcampos.ffin)) {
      ...
      this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Contabilidad/rptConConciliacionLibroBancos';
  ...
  imprimirExcel(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptConConciliacionLibroBancosExcel';
    ...
    if ((this.mcampos.finicio != null && this.mcampos.ffin == null) || (this.mcampos.finicio == null && this.mcampos.ffin != null) || (this.mcampos.finicio > this.mcampos.ffin)) {
      ...
      this.jasper.parametros['@i_fechainicial'] = lfinicio;
      this.jasper.parametros['@i_fechafinal'] = lffin;
      this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Contabilidad/rptConConciliacionLibroBancosExcel';
      this.jasper.generaReporteCore();
