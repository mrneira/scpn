...
@Component({
  selector: 'app-egresosnoefectivizados',
  templateUrl: 'egresosnoefectivizados.html'
})
export class EgresosnoefectivizadosComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptConEgresosNoEfectivizados';
    ...
    if ((this.mcampos.finicio != null && this.mcampos.ffin == null) || (this.mcampos.finicio == null && this.mcampos.ffin != null) || (this.mcampos.finicio > this.mcampos.ffin)) {
      ...
      this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Contabilidad/rptConEgresosNoEfectivizados';
