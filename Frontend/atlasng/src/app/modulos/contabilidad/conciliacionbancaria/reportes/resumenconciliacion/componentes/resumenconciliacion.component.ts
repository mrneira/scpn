...
@Component({
  selector: 'app-resumenconciliacion',
  templateUrl: 'resumenconciliacion.html'
})
export class ResumenconciliacionComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptConResumenConciliacionBancaria';
    ...
    if ((this.mcampos.finicio != null && this.mcampos.ffin == null) || (this.mcampos.finicio == null && this.mcampos.ffin != null) || (this.mcampos.finicio > this.mcampos.ffin)) {
      ...
      this.jasper.parametros['@nusuario'] = this.dtoServicios.mradicacion.np;
      ...
      this.jasper.parametros['@i_saldoParaConciliacion'] = this.mcampos.saldoparaconciliacion;
      this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Contabilidad/rptConConciliacionBancariaBce';
