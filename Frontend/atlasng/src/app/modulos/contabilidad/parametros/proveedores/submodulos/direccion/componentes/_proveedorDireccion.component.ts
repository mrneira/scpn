...
@Component({
  selector: 'app-proveedor-direccion',
  templateUrl: '_proveedorDireccion.html'
})
export class ProveedorDireccionComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public crearDtoConsulta(): Consulta {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.direccion', this.mfiltros, this.mfiltrosesp);
