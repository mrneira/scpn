...
@Component({
  selector: 'app-proveedor-ref-bancaria',
  templateUrl: '_proveedorRefBancaria.html'
})
export class ProveedorRefBancariaComponent extends BaseComponent implements OnInit, AfterViewInit {
