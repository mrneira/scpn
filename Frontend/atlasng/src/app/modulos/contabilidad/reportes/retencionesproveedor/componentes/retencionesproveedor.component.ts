...
@Component({
  selector: 'app-retenciones-proveedor-reporte',
  templateUrl: 'retencionesproveedor.html'
})
export class RetencionesproveedorComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  descargarReporte(): void {
    ...
    if ((this.mcampos.fIngreso != null && this.mcampos.fFinIngreso == null) || (this.mcampos.fIngreso == null && this.mcampos.fFinIngreso != null) || (this.mcampos.fIngreso > this.mcampos.fFinIngreso)) {
      ...
      this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Contabilidad/rptConRetencionesAplicadasProveedor';
