...
@Component({
  ...
  templateUrl: 'estadoCuentaClienteReporte.html'
})
export class EstadoCuentaClienteReporteComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptConEstadoCuentaCliente';
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Contabilidad/rptConEstadoCuentaCliente';
