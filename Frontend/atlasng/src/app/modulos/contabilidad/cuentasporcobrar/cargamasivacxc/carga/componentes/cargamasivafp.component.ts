...
@Component({
  selector: 'app-cxc-cargamasivafp',
  templateUrl: 'cargamasivafp.html'
})
export class CargaMasivaFPComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  fijarLovCuentasContablesSelec(reg: any): void {
    if (reg.registro !== undefined) {
      this.registro.mdatos.cctacajaparqueadero = reg.registro.ccuenta;
