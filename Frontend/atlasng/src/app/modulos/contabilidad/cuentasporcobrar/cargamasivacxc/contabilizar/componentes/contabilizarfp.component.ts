...
@Component({
    selector: 'app-cxc-contabilizarfp',
    templateUrl: 'contabilizarfp.html'
})

export class ContabilizarFPComponent extends BaseComponent implements OnInit, AfterViewInit {
    ...
    grabar(): void {
        ...
        if(this.flagCont){
            ...
            this.rqMantenimiento.mdatos.tipofactura = "D";
