...
@Component({
  selector: 'app-lov-clasificador',
  templateUrl: 'lov.clasificador.html'
})
export class LovClasificadorComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'Tpptclasificador', 'LOVCLASIFICADOR', false, true);
  }
