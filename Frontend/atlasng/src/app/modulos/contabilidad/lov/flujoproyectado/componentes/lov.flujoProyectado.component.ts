...
@Component({
  selector: 'app-lov-flujo-proyectado',
  templateUrl: 'lov.flujoproyectado.html'
})
export class LovFlujoProyectadoComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tpptflujoproyectado', 'LOVFLUJO', false, true);
  }
  ...
  public crearDtoConsulta(): Consulta {
    const consulta = new Consulta(this.entityBean, 'Y', 't.cflujoproyectado', this.mfiltros, this.mfiltrosesp);
