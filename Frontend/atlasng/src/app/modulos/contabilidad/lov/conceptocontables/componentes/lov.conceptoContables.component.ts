...
@Component({
  selector: 'app-lov-concepto-contables',
  templateUrl: 'lov.conceptoContables.html'
})
export class LovConceptoContablesComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TconConcepto', 'LOVCONCEPTO', false, true);
  }
  ...
  public crearDtoConsulta(): Consulta {
    const consulta = new Consulta(this.entityBean, 'Y', 't.cconcepto', this.mfiltros, this.mfiltrosesp);
