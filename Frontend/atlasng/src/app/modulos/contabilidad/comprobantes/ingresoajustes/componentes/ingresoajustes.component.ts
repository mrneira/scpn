...
@Component({
  selector: 'app-ingresoajustes',
  templateUrl: 'ingresoajustes.html'
})
export class IngresoAjustesComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  grabar(): void {
    ...
    for (const i in this.detalleComponent.lregistros) {
      if (this.detalleComponent.lregistros.hasOwnProperty(i)) {
        this.detalleComponent.lregistros[i].fcontable = this.dtoServicios.mradicacion.fcontable;
        this.detalleComponent.lregistros[i].centrocostosccatalogo = this.detalleComponent.lregistros[i].mdatos.centrocostosccatalogo;
        this.detalleComponent.lregistros[i].centrocostoscdetalle = this.detalleComponent.lregistros[i].mdatos.ncentrocostoscdetalle;
      }
    }
  ...
  consultarCatalogos(): void {
    ...
    //this.catalogoDetalle.mfiltrosesp.cdetalle = 'not in (\'DIAGEN\')';
  ...
  validarDatosComprobanteContable(): string {
    ...
    for (const i in this.detalleComponent.lregistros) {
      ...
      if (reg.mdatos.ncentrocostoscdetalle === undefined || reg.mdatos.ncentrocostoscdetalle === null) {
