...
export class ComprobanteComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  crearNuevo() {
    ...
    this.registro.csucursal = 1;
    this.registro.csucursalingreso = 1;
    this.registro.cagencia = 1;
    this.registro.cagenciaingreso = 1;

    this.registro.comentario = "";
    this.registro.numerodocumentobancario = "";
    this.registro.cmodulo = 10;
    this.registro.optlock = 0;
    this.registro.automatico = 0;
    this.registro.tipodocumentoccatalogo = 1003;
    this.registro.mdatos.fcontable = this.integerToDate(this.dtoServicios.mradicacion.fcontable);
