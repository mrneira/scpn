...
export class IngresoComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public ruteopresupuesto = false; // CCA
  ...
  guardarCambios(): void {
    if (this.comprobanteComponent.registro.comentario === undefined) {
      ...
      // CCA cambios 
      //console.log("CCA Datos guardados "+JSON.stringify(this.comprobanteComponent))
      //console.log("CCA Datos guardados registro "+JSON.stringify(this.comprobanteComponent.registro))
    }

    this.rqMantenimiento.cuadrado = false;
    //console.log("CCA Datos guardados "+JSON.stringify(this.comprobanteComponent))
    //console.log("CCA Datos guardados registro "+JSON.stringify(this.comprobanteComponent.registro))
    //console.log("CCA Datos guardados rqMantenimiento "+JSON.stringify(this.rqMantenimiento))
    // this.rqMantenimiento.actualizarsaldos = false;
    //this.rqMantenimiento.actualizarsaldos = true;
    if (this.ruteopresupuesto) {
      //console.log("CCA ruteopresupuestio verdadero")
      this.ruteopresupuesto = true;
      this.bandera = true;
      //console.log("CCA ruteopresupuestio "+this.ruteopresupuesto+"nuevo"+this.nuevo+"eliminado"+this.eliminado+"actualizoSaldo"+this.actualizosaldo)
    }else{
      //console.log("CCA ruteopresupuestio falso")
      this.ruteopresupuesto = false;
      this.bandera = true;
      //console.log("CCA ruteopresupuestio "+this.ruteopresupuesto+"nuevo"+this.nuevo+"eliminado"+this.eliminado+"actualizoSaldo"+this.actualizosaldo)
    }
    this.grabar();
  ...
  grabar(): void {
    ...
    //this.rqMantenimiento.mdatos.ruteopresupuesto = 1;
    ...
    if (this.ruteopresupuesto) {
      this.comprobanteComponent.registro.ruteopresupuesto = true; /// CCA
      //console.log("CCA ruteopresupuesto grabar"+this.ruteopresupuesto)
    }else{
      this.comprobanteComponent.registro.ruteopresupuesto = false; /// CCA
      //console.log("CCA ruteopresupuesto grabar"+this.ruteopresupuesto)
    }
    ...
    //console.log("CCA mantenimiento comprobanteComponent "+JSON.stringify(this.comprobanteComponent.getMantenimiento(1)))
    //console.log("CCA mantenimiento detalleComponent "+JSON.stringify(this.detalleComponent.getMantenimiento(2)))
