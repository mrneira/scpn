...
@Component({
    selector: 'app-lov-impuesto',
    templateUrl: 'lov.impuesto.html'
})
export class LovImpuestoComponent extends BaseComponent implements OnInit, AfterViewInit {
    ...
    constructor(router: Router, dtoServicios: DtoServicios) {
        super(router, dtoServicios, 'TfacImpuesto', 'LOVIMPUESTO', false, false);
