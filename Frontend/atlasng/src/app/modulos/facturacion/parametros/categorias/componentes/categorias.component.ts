...
export class CategoriasComponent extends BaseComponent implements OnInit, AfterViewInit {
    ...
    constructor(router: Router, dtoServicios: DtoServicios) {
        super(router, dtoServicios, 'TfacCategoria', 'TFACCATEGORIA', false);
    ...
    ngOnInit() {
        ...
        this.tiposmenu = [];
        this.tiposmenu.push({ label: 'Grupo Categoría', value: false });
        this.tiposmenu.push({ label: 'Categoría Final', value: true });
    }
    ...
    private fijarFiltrosConsulta() {
        // this.mfiltrosigual.ccategoria_ccompania = this.dtoServicios.mradicacion.ccompania;
    }
    ...
    private obtenerSecuenciaMenu() {
        ...
        metadataMantenimiento['NSECUENCIA'] = 'CCATEGPROD';
        ...
        this.dtoServicios.ejecutarRestMantenimiento(metadataMantenimiento).subscribe(
            resp => {
                ...
                this.registro.ccategoria = secuenciaimp;
                this.registro.cpadre = !this.estaVacio(this.nodoSeleccionado.data.reg.ccategoria) ? this.nodoSeleccionado.data.reg.ccategoria : null;
                this.nuevoNodo = {
                    'data': {
                        'nombre': '',
                        'reg': this.registro,
