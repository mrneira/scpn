...
@Component({
  selector: 'app-b15Reporte',
  templateUrl: 'b15Reporte.html'
})
export class B15ReporteComponent extends BaseComponent implements OnInit, AfterViewInit {

  public ltipoplancuentas: SelectItem[] = [{label: '...', value: null}];
  public lmesesini: SelectItem[] = [{label: '...', value: null}];

  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, '', 'REPORTEB15', false);
  ...
  llenarConsultaCatalogos(): void {
    const mfiltrosEstUsr: any = {'ccatalogo': 1001,'cdetalle':'PC-ADF'};
  ...
  public generarReporte() {
    this.rqConsulta.CODIGOCONSULTA = 'OC_B15REPORTE';
    this.rqConsulta.storeprocedure = "sp_OdcRptReporteb15";
    ...
    this.dtoServicios.ejecutarConsultaRest(this.rqConsulta)
      ...
      resp => {
        ...
        this.lregistros = resp.OC_B15REPORTE;
      },
      error => {
        this.dtoServicios.manejoError(error);
      });
   ...
   imprimir(resp: any): void {
    ...
    var separador = ('\t');; 
    var salto = ('\r\n');
    var cabecera = 'B15'+ separador + this.lregistros[0].codigo + separador + fechaUltimoDia  + '/' + this.mfiltros.finicio +'/'  + this.mfiltros.fperiodo;
    var contador = 0;
    var numerolineas = 0;
    var cuadre =0;
      ...
      if (this.lregistros.hasOwnProperty(i)) {
        const reg = this.lregistros[i];
         if (reg.ccuenta !== undefined && reg.ccuenta !== null) {
            ...
            if( reg.ccuenta === '3301' || reg.ccuenta === '3302' || reg.ccuenta === '33' || reg.ccuenta === '3' || reg.ccuenta === '6' )
            {
              reg.monto = '0.00'
            }      
          ...
          linkElement1.download = "B15M" + this.lregistros[0].codigo + + fechaUltimoDia + '' + this.mfiltros.finicio + '' + this.mfiltros.fperiodo + '.'+"txt";
