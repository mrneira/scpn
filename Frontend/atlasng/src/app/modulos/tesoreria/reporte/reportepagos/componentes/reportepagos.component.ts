...
@Component({
  selector: 'app-reporte-reportepagos',
  templateUrl: 'reportepagos.html'
})
export class ReportePagosComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'ttestransaccion', 'REPORTEPAGOS', false);
  ...
  consultarPagos() {
    ...
    this.rqConsulta.storeprocedure = "sp_TesConReportePagos";
  ...
  public imprimir(resp: any): void {
    this.jasper.nombreArchivo = 'ReportePagoSpi';
    ...
    this.jasper.parametros['@i_tipotransaccion'] = 'P';
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Tesoreria/rptTes_ReportePagos';
