...
@Component({
  selector: 'app-numeroreferenciabce',
  templateUrl: 'numeroreferenciabce.html'
})
export class NumeroReferenciaBceComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'ttesreferencia', 'NumeroReferencia', false, true);
  ...
  public crearDtoConsulta(): Consulta {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.ctesreferencia', this.mfiltros, this.mfiltrosesp);
