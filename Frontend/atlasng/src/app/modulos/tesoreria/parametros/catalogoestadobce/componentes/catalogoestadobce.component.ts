...
@Component({
  selector: 'app-catalogoestadobce',
  templateUrl: 'catalogoestadobce.html'
})
export class CatalogoEstadoBceComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'ttescatalogoestado', 'CatalogoEstadoBce', false, true);
