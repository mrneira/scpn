...
@Component({
  selector: 'app-registrodocumento',
  templateUrl: 'registrodocumento.html'
})
export class RegistroDocumentoComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tconlibrobancos', 'REGISTRODOCUMENTO', false, false);
