...
@Component({
  selector: 'app-eliminarpagospi',
  templateUrl: 'eliminarpagospi.html'
})
export class EliminarPagoSpiComponent extends BaseComponent implements OnInit, AfterViewInit {
