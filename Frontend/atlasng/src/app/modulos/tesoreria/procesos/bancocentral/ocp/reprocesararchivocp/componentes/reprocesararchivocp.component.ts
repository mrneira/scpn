...
@Component({
  selector: 'app-reprocesararchivocp',
  templateUrl: 'reprocesararchivocp.html'
})
export class ReprocesarArchivOcpComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'ttestransaccion', 'TRANSACCIONOCP', false);
  ...
  grabar(): void {
    ...
    this.rqMantenimiento.mdatos.TRANSACCIONOCP = this.lregistros;
    ...
    this.rqMantenimiento.mdatos.tipoArchivo = 'ocp';
