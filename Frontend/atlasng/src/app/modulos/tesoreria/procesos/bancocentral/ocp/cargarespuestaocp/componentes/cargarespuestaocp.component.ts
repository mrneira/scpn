...
@Component({
  selector: 'app-cargarespuestaocp',
  templateUrl: 'cargarespuestaocp.html'
})
export class CargaRespuestaOcpComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'ABSTRACT', 'CABECERARESPUESTAOCP', false, false);
  ...
  grabar(): void {
    if (!this.grabo) {
      ...
      this.rqMantenimiento.mdatos.CABECERARESPUESTAOCP = this.lregistros;
