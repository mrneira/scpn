...
@Component({
  selector: 'app-carga-partidagasto',
  templateUrl: 'cargarpartidagasto.html'
})
export class CargarPartidaGastoComponent extends BaseComponent implements OnInit, AfterViewInit {
