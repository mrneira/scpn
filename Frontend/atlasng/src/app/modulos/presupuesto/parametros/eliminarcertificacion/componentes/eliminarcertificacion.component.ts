...
@Component({
  ...
  templateUrl: 'eliminarcertificacion.html'
})
export class EliminarCertificacionComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  mostrarlovCertificacion(): void {
    ...
    this.lovcertificacion.mfiltros.estadocdetalle = 'CERTIF';
