...
@Component({
  ...
  templateUrl: 'ingresocompromiso.html'
})
export class IngresoCompromisoComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  ngAfterViewInit() {
    this.route['queryParams'].subscribe((p: any) => {
      if (p.comprobante) {
        ...
        this.cmodulo = comprobante.cmodulo;
        this.consultar();
      }
    });
  }
  ...
  public postCommit(resp: any) {
    ...
    if (resp.cod === "OK"){
      ...
      //this.descargarReporteAfectacion(); //CCA 20211126
