...
@Component({
  selector: "app-movimientospartidagasto",
  templateUrl: "movimientospartidagasto.html"
})
export class MovimientosPartidaGastoComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public imprimir(resp: any): void {
    this.jasper.nombreArchivo = 'RptMovimientosPartidaGasto';
    // Agregar parametros
    this.jasper.parametros['@i_anio'] = this.mfiltros.anio;
    this.jasper.parametros['@i_mes'] = this.mfiltros.finicio;
    
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Presupuesto/rptPptMovimientosPartidaGasto';
