...
@Component({
  selector: 'app-certificacionPresupuestaria',
  templateUrl: 'certificacionPresupuestaria.html'
})
export class CertificacionPresupuestariaComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'rptPptCertificacionPresupuestaria';
