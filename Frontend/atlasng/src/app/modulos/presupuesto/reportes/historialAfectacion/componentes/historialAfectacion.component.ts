...
@Component({
  selector: 'app-reporte-historialAfectacion',
  templateUrl: 'historialAfectacion.html'
})
export class HistorialAfectacionComponent extends BaseComponent implements OnInit, AfterViewInit {
