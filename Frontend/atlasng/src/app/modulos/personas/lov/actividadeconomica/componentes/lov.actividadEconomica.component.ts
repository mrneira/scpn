...
@Component({
  selector: 'app-lov-act-economica',
  templateUrl: 'lov.actividadEconomica.html'
})
export class LovActividadEconomicaComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TperActividadEconomica', 'LOVACTECONOM', false);
  }
