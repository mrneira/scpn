...
@Component({
  selector: 'app-persona-sucursal',
  templateUrl: '_personaSucursal.html'
})
export class PersonaSucursalComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TperJuridicaSucursales', 'SUCURSAL', false);
