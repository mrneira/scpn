...
@Component({
  selector: 'app-productosuministros',
  templateUrl: 'productosuministros.html'
})
export class ProductoSuministrosComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  crearNuevo() {
    ...
    this.registro.cusuarioing = this.dtoServicios.mradicacion.ccompania;
  ...
  public crearDtoConsulta(): Consulta {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.codigo, t.padre, t.nombre', this.mfiltros, this.mfiltrosesp);
  ...
  private fijarFiltrosConsulta() {
    this.mfiltrosesp.ctipoproducto = 'in (3)';;
  }
