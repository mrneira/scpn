...
@Component({
  selector: 'app-reporte-historialDepreciacion',
  templateUrl: 'historialDepreciacionReporte.html'
})
export class HistorialDepreciacionReporteComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tacfhistorialDepreciacion', 'historialDepreciacion',false)
  ...
  consultarHistorial() {
    this.rqConsulta.CODIGOCONSULTA = 'AF_historialDepreciacion';
    this.rqConsulta.storeprocedure = "sp_AcfConHistorialDepreciacion";
  ...
  private manejaRespuestaHistorial(resp: any) {
    this.lregistros = [];
    if (resp.cod === 'OK') {
      this.lregistros = resp.AF_historialDepreciacion;
    }
  }
  ...
  descargarReporte(reg: any): void {
    ...
    this.jasper.nombreArchivo = 'ReporteHistorialDepreciacion';
    // Agregar parametros
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/ActivosFijos/rptAcfHistorialDepreciacion';
