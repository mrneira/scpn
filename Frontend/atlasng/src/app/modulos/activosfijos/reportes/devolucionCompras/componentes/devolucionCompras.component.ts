...
@Component({
  selector: 'app-devolucionCompras',
  templateUrl: 'devolucionCompras.html'
})
export class DevolucionComprasComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  descargarReporte(): void {
    ...
    this.jasper.nombreArchivo = 'ReporteDevolucionCompras';
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/ActivosFijos/rptAcfDevolucionCompras';
