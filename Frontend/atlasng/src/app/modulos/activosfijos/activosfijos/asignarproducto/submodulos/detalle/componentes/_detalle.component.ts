...
import { LovKardexProdCodiComponent } from '../../../../../lov/kardexprodcodi/componentes/lov.kardexprodcodi.component';
...
export class DetalleComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  @ViewChild(LovKardexProdCodiComponent)
  private lovkardexprodcodi: LovKardexProdCodiComponent;
      ...
      if (lista.hasOwnProperty(i)) {
        ...
        for (j = 0; j < reg.cantidad; j++) {
          listaResp.push({
            ...
            infoadicional: reg.infoadicional
          });
          k++;
        }
      }
  ...
  mostrarlovkardexprodcodi(): void {

    this.lovkardexprodcodi.showDialog();
  }

  fijarlovkardexprodcodiSelec(reg: any): void {
