...
@Component({
  selector: 'app-ajusteactivos',
  templateUrl: 'ajusteactivos.html'
})
export class AjusteActivosComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public crearDtoConsulta() {
    ...
    conCabecera.addSubquery('tthfuncionariodetalle','primernombre + \' \' + primerapellido','nfuncionarioavala','i.cpersona= t.cusuarioavala and i.verreg = 0' );
  ...
  public postQuery(resp: any) {
    ...
    if(this.cabeceraComponent.registro.eliminado === true){
      this.eliminado = true;
    }
    else
    {
  ...
  grabar(): void {
    ...
    this.cabeceraComponent.registro.movimiento = 'A';
  ...
  mostrarlovajustes(): void {
    ...
    this.lovajustes.mfiltros.movimiento = 'A';
  ...
  validarInventarioCongelado(){
    ...
    const consulta = new Consulta('tacfinventariocongelado', 'Y', '', {'congelaactivos':false }, {});
  ...
  descargarReporte(): void {
    if (this.cabeceraComponent.registro.cajuste === undefined) {
      super.mostrarMensajeError('Por favor seleccione un ajuste');
      return;
    }
