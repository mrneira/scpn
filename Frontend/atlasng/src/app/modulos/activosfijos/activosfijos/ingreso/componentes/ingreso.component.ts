...
export class IngresoComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  calcularTotales() {
    ...
    this.cabeceraComponent.registro.subtotaliva = sumatoriobaseiva; //CCA linea descomentada
    //this.cabeceraComponent.registro.subtotaliva = this.detalleComponent.totalValorTotal + this.cabeceraComponent.registro.ice; //CCA linea comentada
    //this.cabeceraComponent.registro.subtotalsinimpuestos = this.detalleComponent.totalValorTotal;
    this.cabeceraComponent.registro.subtotalsinimpuestos = sumatoriobaseiva; //CCA aumento de suma subtotalivacero   
    this.cabeceraComponent.registro.valortotal =this.cabeceraComponent.registro.subtotalsinimpuestos + this.cabeceraComponent.registro.subtotalivacero - this.cabeceraComponent.registro.descuento +
