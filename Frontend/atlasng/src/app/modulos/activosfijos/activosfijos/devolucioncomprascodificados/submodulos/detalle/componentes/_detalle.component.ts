...
export class DetalleComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tacfproductocodificado', 'DETALLE', false);
  ...
  public crearDtoConsulta() {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.cbarras', {'cusuarioasignado':'BODEGA','estado': 1 ,'cingreso': this.mcampos.cingreso },{});    
