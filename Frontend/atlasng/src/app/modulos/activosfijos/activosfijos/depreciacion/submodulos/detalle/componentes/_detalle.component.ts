...
export class DetalleComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public crearDtoConsulta() {
    ...
    this.mfiltrosesp.cproducto = 'IN(select cproducto from tacfproducto where ctipoproducto = 1)';
  ...
  private manejaRespuesta(resp: any) {
    ...
    for (const i in resp.DETALLE) {
      ...
      valorlibros =  reg.vunitario - depreciacionperiodo;
      depacumulada = depreciacionperiodo + reg.valdepacumulada;
