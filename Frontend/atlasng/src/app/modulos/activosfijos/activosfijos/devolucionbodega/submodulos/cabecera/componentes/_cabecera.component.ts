...
export class CabeceraComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tacfingreso', 'CABECERA', true);
  ...
  crearNuevo() {
    ...
    this.registro.tipoingresoccatalogo = 1303;
    this.registro.tipoingresocdetalle = 'DEVBOD';
    this.registro.estadoingresoccatalogo = 1304;
    this.registro.estadoingresocdetalle = 'CODIFI';
    this.registro.memoautorizacion = this.registro.numeromemo;
