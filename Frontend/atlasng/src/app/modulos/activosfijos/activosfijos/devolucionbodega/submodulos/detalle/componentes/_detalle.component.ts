...
export class DetalleComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public crearDtoConsulta() {
    ...
    consulta.addSubquery('tacfkardexprodcodi', 'serial', 'serial', 'i.cproducto = t.cproducto  and i.cmovimiento=t.cingreso');
    consulta.addSubquery('tacfkardexprodcodi', 'cbarras', 'cbarras', 'i.cproducto = t.cproducto  and i.cmovimiento=t.cingreso');
