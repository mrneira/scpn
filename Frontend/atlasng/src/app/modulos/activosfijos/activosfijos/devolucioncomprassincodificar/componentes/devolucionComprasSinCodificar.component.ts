...
@Component({
  selector: 'app-devolucionComprasSinCodificar',
  templateUrl: 'devolucionComprasSinCodificar.html'
})
export class DevolucionComprasSinCodificarComponent extends BaseComponent implements OnInit, AfterViewInit {
 ...
 constructor(router: Router, dtoServicios: DtoServicios) {
  ...
  guardarCambios(): void {
    ...
    this.rqMantenimiento.mdatos.cingreso = this.cabeceraComponent.mfiltros.cingreso;
    this.grabar();
  }
  ...
  private manejaRespuestaDevolucion(resp: any) {
