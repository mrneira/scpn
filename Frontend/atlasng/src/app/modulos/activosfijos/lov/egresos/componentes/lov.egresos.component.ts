...
@Component({
  selector: 'app-lov-egresos',
  templateUrl: 'lov.egresos.html'
})
export class LovEgresosComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tacfegreso', 'LOVEGRESOS', false, true);
  }
  ...
  public crearDtoConsulta(): Consulta {
    ...
    this.mfiltrosesp.fecha = 'between \'' + lfechainicial + '\' and \'' + lfechafinal + '\'';
