...
@Component({
  selector: 'app-evaluacionperiodo',
  templateUrl: 'evaluacionperiodo.html'
})
export class EvaluacionperiodoComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tthevaluacionperiodo', 'EVALUACIONPERIODO', false, false);
...
validarFecha() {
  if (!this.estaVacio(this.registro.finicio)) {
    this.mcampos.fmin = new Date(this.registro.ffin);
