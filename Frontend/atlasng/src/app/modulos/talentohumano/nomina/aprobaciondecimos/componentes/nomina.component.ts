...
export class NominaComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public itemsNomina: MenuItem[] = [{ label: 'Aprobar Décimos', icon: 'ui-icon-circle-arrow-e', command: () => { this.aprobarEtapa(); } },
  { label: 'Rechazar Décimos', icon: 'ui-icon-circle-arrow-w', command: () => { this.rechazarEtapa(); } }];
  public ldatos: any = [];
  ...
  private fijarFiltrosConsulta() {
    ...
    this.mfiltrosesp.direjecutiva="is null";
    
    this.mfiltrosesp.tipocdetalle="NOT IN (\'GEN\')";
