...
@Component({
  selector: 'app-rolpago',
  templateUrl: 'rolpago.html'
})
export class RolpagoComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tnomrol', 'ROLPAGO', false, false);
