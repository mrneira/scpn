...
@Component({
    selector: 'app-tth-aprobacionotrosingresos',
    templateUrl: 'aprobacionotrosingresos.html'
})

export class AprobacionOtrosIngresosComponent extends BaseComponent implements OnInit, AfterViewInit {
