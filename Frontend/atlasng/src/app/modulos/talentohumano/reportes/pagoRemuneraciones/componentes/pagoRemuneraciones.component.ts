...
@Component({
  selector: 'app-reporte-pagoRemuneraciones',
  templateUrl: 'pagoRemuneraciones.html'
})
export class PagoRemuneracionesComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  descargarReporte(): void {
    ...
    this.jasper.nombreArchivo = 'ReportePagoRemuneraciones';

    if (this.mfiltros.cfuncionario === undefined || this.mfiltros.cfuncionario === null) {
      this.mfiltros.cfuncionario = -1;
    }
    
    if (this.mfiltros.departamento === undefined || this.mfiltros.departamento === null) {
    ...
    this.jasper.parametros['@i_departamento'] = this.mfiltros.departamento;
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/TalentoHumano/PagoRemuneraciones';
    this.jasper.generaReporteCore();
    this.mfiltros.cfuncionario=null;
  }
