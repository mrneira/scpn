...
@Component({
  selector: 'app-reporte-consolidadoPercepcionNJS',
  templateUrl: 'consolidadoPercepcionNJS.html'
})
export class ConsolidadoPercepcionNJSComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'ABSTRACT', 'consolidadoPercepcionNJS', false);
  ...
  descargarReporte(): void {
    ...
    this.jasper.nombreArchivo = 'ConsolidadoDePercepcionAlNivelJerarquicoSuperior';
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/TalentoHumano/rptTthConsolidadoPercepcionNJS';
