...
@Component({
  selector: 'app-evaluacionAsignacionnjs',
  templateUrl: 'evaluacionAsignacionnjs.html'
})
export class EvaluacionAsignacionnjsComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios, private confirmationService: ConfirmationService) {
    super(router, dtoServicios, 'tthasignacionnjs', 'EVALASIGNACIONNJS', false, false);
  ...
  consultarCatalogos(): void {
    ...
    this.addConsultaCatalogos('TABL2', consultarParametro2, this.cinfoempresa, super.llenaListaCatalogo, 'numero',false,false);
    ...
    this.addConsultaCatalogos('TABL3', consultarParametro3, this.cversion, super.llenaListaCatalogo, 'numero',false,false); 
    ...
    if (lista.length > 0) {
      for (const i in lista) {
        if (lista.hasOwnProperty(i)) {
          ...
          registronuevo.cversion = this.cversion;
          registronuevo.cinfoempresa = this.cinfoempresa;
