...
export class ConocimientoComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tthconocimiento', 'CONOCIMIENTO', false, false);
  ...
  public crearDtoConsulta(): Consulta {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.cconocimiento', this.mfiltros, this.mfiltrosesp);
