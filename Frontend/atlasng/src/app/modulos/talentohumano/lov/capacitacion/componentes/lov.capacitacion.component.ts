...
@Component({
  selector: 'app-lov-capacitacion',
  templateUrl: 'lov.capacitacion.html'
})
export class LovCapacitacionComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tthinstruccioncesantia', 'CAPACITACION', false, false);
  }
  ngOnInit() {
