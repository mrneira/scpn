...
@Component({
  selector: 'app-lov-beneficio',
  templateUrl: 'lov.beneficio.html'
})
export class LovBeneficioComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tnombeneficio', 'LOVBENEFICIO', false, false);
  }
  ngOnInit() {
