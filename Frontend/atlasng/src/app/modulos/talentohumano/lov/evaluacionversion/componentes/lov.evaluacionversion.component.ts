...
@Component({
  selector: 'app-lov-evaluacionversion',
  templateUrl: 'lov.evaluacionversion.html'
})
export class LovEvaluacionversionComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tthevaluacionversion', 'LOVVERSION', false, false);
  }
  ngOnInit() {
