...
export class LovFuncionariosEvaluadosComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tthasignacionnjs', 'LOVFUNCIONARIO', false, false);
  }
  ...
  public crearDtoConsulta(): Consulta {
    ...
    consulta.addSubquery('tthasignacionrespnjs', 'cevaluacion', 'cevaluacions', 'i.cevaluacion = t.cevaluacion');
