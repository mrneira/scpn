...
@Component({
  selector: 'app-lov-parametroanual',
  templateUrl: 'lov.parametroanual.html'
})
export class ParametroanualComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tnomparametrodetalle', 'LOVPARAMETROANUAL', false, false);
  }
  ngOnInit() {
