...
@Component({
  selector: 'app-lov-cargo',
  templateUrl: 'lov.cargo.html'
})
export class LovCargoComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tthcargo', 'LOVCARGO', false, false);
  }
  ngOnInit() {
