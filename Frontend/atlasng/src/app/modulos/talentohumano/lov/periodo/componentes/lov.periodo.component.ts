...
@Component({
  selector: 'app-lov-periodo',
  templateUrl: 'lov.periodo.html'
})
export class LovPeriodoComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tthevaluacionperiodo', 'LOVPERIODO', false, false);
  }
  ngOnInit() {
