...
@Component({
  selector: 'app-lov-matrizcorrelacion',
  templateUrl: 'lov.matrizcorrelacion.html'
})
export class LovMatrizCorrelacionComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tthmatrizcorrelacion', 'LOVMATRIZCORRELACION', false, false);
  }
  ngOnInit() {
