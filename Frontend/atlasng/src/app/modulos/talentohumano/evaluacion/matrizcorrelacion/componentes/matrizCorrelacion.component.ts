...
@Component({
  selector: 'app-MatrizCorrelacion',
  templateUrl: 'MatrizCorrelacion.html'
})
export class MatrizCorrelacionComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios, private confirmationService: ConfirmationService) {
    super(router, dtoServicios, 'tthmatrizcorrelacion', 'MATRIZCORRELACION', false, false);
  ...
  public crearDtoConsulta(): Consulta {
    ...
    consulta.addSubquery('tthevaluacionversion','nombre','nversion','i.cversion = t.cversion');
