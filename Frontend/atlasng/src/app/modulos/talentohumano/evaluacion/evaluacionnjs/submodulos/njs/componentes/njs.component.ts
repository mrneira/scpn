...
@Component({
  ...
  templateUrl: 'njs.html'
})

export class NjsDetalleComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tthasignacionrespnjsdetalle', 'EVALINTERNADETALLE', false, true);
  ...
  public crearDtoConsulta(): Consulta {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.casignaciondetalle', this.mfiltros, this.mfiltrosesp);
  ...
  actualizarTotal() {
    ...
    let total = totalcomTecni / (this.ponderacion*totalregistros);
