...
@Component({
  selector: 'app-lov-parroquias',
  templateUrl: 'lov.parroquias.html'
})
export class LovParroquiasComponent extends BaseComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TgenParroquia', 'LOVPARROQUIA', false, false);
  }
