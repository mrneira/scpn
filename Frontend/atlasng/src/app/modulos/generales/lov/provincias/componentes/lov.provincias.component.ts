...
@Component({
  selector: 'app-lov-provincias',
  templateUrl: 'lov.provincias.html'
})
export class LovProvinciasComponent extends BaseComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TgenProvincia', 'LOVPROVINCIA', false, false);
  }
