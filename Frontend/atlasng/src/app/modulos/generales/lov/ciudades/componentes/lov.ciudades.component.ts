...
@Component({
  selector: 'app-lov-ciudades',
  templateUrl: 'lov.ciudades.html'
})
export class LovCiudadesComponent extends BaseComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TgenCiudad', 'LOVCIUDAD', false, false);
  }
