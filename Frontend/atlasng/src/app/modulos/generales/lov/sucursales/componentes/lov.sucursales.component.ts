...
@Component({
  selector: 'app-lov-sucursales',
  templateUrl: 'lov.sucursales.html'
})
export class LovSucursalesComponent extends BaseComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tgensucursal', 'LOVSUCURSAL', false, false);
  }
