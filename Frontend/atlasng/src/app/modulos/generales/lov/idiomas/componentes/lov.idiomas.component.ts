...
@Component({
  selector: 'app-lov-idiomas',
  templateUrl: 'lov.idiomas.html'
})
export class LovIdiomasComponent extends BaseComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tgenidioma', 'LOVIDIOMA', false, false);
  }
