...
@Component({
  selector: 'app-lov-cantones',
  templateUrl: 'lov.cantones.html'
})
export class LovCantonesComponent extends BaseComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TgenCanton', 'LOVCANTON', false, false);
  }
