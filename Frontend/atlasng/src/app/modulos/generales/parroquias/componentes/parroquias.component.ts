...
@Component({
  ...
  templateUrl: 'parroquias.html'
})
export class ParroquiasComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TgenParroquia', 'PARROQUIA', false);
