...
export class AutorizacionComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tcellogdocumentos', 'AUTORIZACIONLOGDOCUMENTOS', false, false);
  ...
  public crearDtoConsulta(): Consulta {
    ...
    this.mfiltros.esreenvio = false;
    this.mfiltros.estado = 1;
  ...
  public postQuery(resp: any) {
    ...
    //this.lregistros.xmlfirmado=undefined;
  }
