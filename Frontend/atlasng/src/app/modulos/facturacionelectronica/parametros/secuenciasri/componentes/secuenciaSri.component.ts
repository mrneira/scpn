...
@Component({
  selector: 'app-secuenciasri',
  templateUrl: 'secuenciaSri.html'
})
export class SecuenciaSriComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tcelsecuenciasri', 'secuenciasri', false, true);
  ...
  crearNuevo() {
    super.crearNuevo();
    this.registro.tipodocumentoccatalogo = 1018;
  ...
  public crearDtoConsulta(): Consulta {
    ...
    const consulta = new Consulta(this.entityBean, 'Y', 't.csecuenciasri', this.mfiltros, this.mfiltrosesp);
  ...
  consultarCatalogos(): void {
    ...
    this.catalogoDetalle.mfiltros.ccatalogo = 1018;
    const conTipoplan = this.catalogoDetalle.crearDtoConsulta();
    this.addConsultaCatalogos('tipodocumento', conTipoplan, this.ltipodocumentocdetalle, super.llenaListaCatalogo, 'cdetalle');
