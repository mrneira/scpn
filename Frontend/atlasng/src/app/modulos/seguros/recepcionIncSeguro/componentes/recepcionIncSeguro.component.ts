...
@Component({
  selector: 'app-recepcionInc-seguro',
  templateUrl: 'recepcionIncSeguro.html'
})
export class RecepcionIncSeguroComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'TsgsSeguro', 'SEGUROINCREMENTO', true, true);
