...
@Component({
  ...
  templateUrl: 'buzonGenPoliza.html'
})
export class BuzonGenPolizaComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public fijarFiltrosConsulta() {
    ...
    this.mfiltrosesp.ctiposeguro = 'in (2,3)';
