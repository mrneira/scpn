...
@Component({
  selector: 'app-recepcion-seguro',
  templateUrl: 'recepcionSeguro.html'
})
export class RecepcionSeguroComponent extends BaseComponent implements OnInit, AfterViewInit {
