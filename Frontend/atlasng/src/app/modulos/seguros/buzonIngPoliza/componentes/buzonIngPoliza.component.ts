...
@Component({
  ...
  templateUrl: 'buzonIngPoliza.html'
})
export class BuzonIngPolizaComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios,private confirmationService: ConfirmationService) {
    super(router, dtoServicios, 'TsgsPoliza', 'BUZONPOLIZASNUEVAS', false, true);
  ...
  public fijarFiltrosConsulta() {
    ...
    this.mfiltros.renovacion = false;
  }
