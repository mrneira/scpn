...
export class LovUsuariosComponent extends BaseLovComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'ABSTRACT', 'LOVUSUARIOS', false, false);
  }
  ...
  consultar() {
    this.rqConsulta.mdatos.CODIGOCONSULTA = 'LOVUSUARIOS';
