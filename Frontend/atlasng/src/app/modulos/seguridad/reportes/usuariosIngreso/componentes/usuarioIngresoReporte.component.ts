...
@Component({
  ...
  templateUrl: 'usuarioIngresoReporte.html'
})
export class UsuarioIngresoReporteComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  descargarReporte(): void {
    this.jasper.nombreArchivo = 'ReporteUsuariosIngreso';
    ...
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Seguridad/ingresoUsuarios';
