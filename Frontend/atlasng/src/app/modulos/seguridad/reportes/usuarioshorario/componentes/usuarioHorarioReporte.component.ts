...
@Component({
  ...
  templateUrl: 'usuarioHorarioReporte.html'
})
export class UsuarioHorarioReporteComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, '', 'REPORTEUSUARIOSPORHORARIO', false);
  ...
  descargarReporte(): void {
    ...
    this.jasper.nombreArchivo = 'ReporteUsuariosPorHorario';
    ...
    if (this.mcampos.dia === undefined || this.mcampos.dia === null) {
      this.mcampos.dia = -1
    }
    ...
    this.jasper.parametros['@i_dia'] = this.mcampos.dia;
    this.jasper.parametros['@i_usuariolog'] = this.dtoServicios.mradicacion.np;
  
    this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Seguridad/usuario_horario';
