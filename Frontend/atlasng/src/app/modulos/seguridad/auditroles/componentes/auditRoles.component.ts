...
@Component({
  selector: 'app-audit',
  templateUrl: 'auditRoles.html'
})
export class AuditRolesComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public crearDtoConsulta(): Consulta {
    ...
    consulta.addFiltroCondicion('ctransaccion', this.ctransaccion, '=');
  ...
  consultarCatalogos(): any {
    ...
    this.addConsultaCatalogos('PERFILES', consultaRol, this.lperfiles, super.llenaListaCatalogo, 'crol', null);
