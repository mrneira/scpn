...
lregistrosconflicto :any;
  ...
  public crearDtoConsulta(): Consulta {
    ...
    consulta.addSubquery('tgencargaarchivo', 'nombre', 'nctipoarchivo', 't.cmodulo = i.cmodulo and t.ctipoarchivo = i.ctipoarchivo');
    this.addConsulta(consulta);
    return consulta;
  }

  public fijarFiltrosConsulta() {
    this.mfiltros.cmodulo = 28;
    this.mfiltros.cresultado = 'E'
    //   numerolinea = pnumeroline        
    //   ctipoarchivo = pctipoarchivo;      
  }
  ...
  public postQuery(resp: any) {
    ...
    this.lregistrosconflicto = resp.LREGISTROSCONFLICTO;
    //this.mostrarMensajeSuccess("CARGA DE ARCHIVO CORRECTA");
  }
  // Fin CONSULTA *********************
