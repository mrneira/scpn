...
@Component({
  ...
  templateUrl: 'listadoExpedienteActuarialReporte.html'
})
export class ListadoExpedienteActuarialReporteComponent extends BaseComponent implements OnInit, AfterViewInit {
  ...
  public selectedEtapas: any = [];

  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, '', 'REPORTELISTADOEXPEDIENTEACTUARIAL', false);
  ...
  imprimir(resp: any): void {
    ...
    this.jasper.nombreArchivo = 'ReporteListadoExpedienteActuarial';
    ...
    if (this.mcampos.etapa === undefined || this.mcampos.etapa === null) {
      ...
      this.jasper.parametros['archivoReporteUrl'] = '/CesantiaReportes/Prestaciones/ListadoExpedienteActuarial';
