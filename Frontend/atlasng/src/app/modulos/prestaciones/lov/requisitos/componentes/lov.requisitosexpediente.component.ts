...
@Component({
  selector: 'app-lov-requisitos-expediente',
  templateUrl: 'lov.requisitosexpediente.html'
})
export class LovRequisitosExpedienteComponent extends BaseComponent implements OnInit {
  ...
  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tprerequisitos', 'LOVREQUISITOS', false, true);
  }
