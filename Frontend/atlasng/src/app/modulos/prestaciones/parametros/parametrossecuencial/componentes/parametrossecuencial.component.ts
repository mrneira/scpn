...
@Component({
  selector: 'app-parametros-secuencial',
  templateUrl: 'parametrossecuencial.html'
})
export class ParametrosSecuencialComponent extends BaseComponent implements OnInit, AfterViewInit {

  @ViewChild('formFiltros') formFiltros: NgForm;
  public ljerarquia: SelectItem[] = [{ label: '...', value: null }];

  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tpresecuencialexpediente', 'SECUENCIALEXP', false);
