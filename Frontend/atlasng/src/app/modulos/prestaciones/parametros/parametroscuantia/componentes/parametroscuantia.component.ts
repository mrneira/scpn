...
@Component({
  selector: 'app-parametros-cuantia',
  templateUrl: 'parametroscuantia.html'
})
export class ParametrosCuantiaComponent extends BaseComponent implements OnInit, AfterViewInit {

  @ViewChild('formFiltros') formFiltros: NgForm;
  public ljerarquia: SelectItem[] = [{ label: '...', value: null }];

  constructor(router: Router, dtoServicios: DtoServicios) {
    super(router, dtoServicios, 'tprecuantiabasica', 'CUANTIABAS', false);
