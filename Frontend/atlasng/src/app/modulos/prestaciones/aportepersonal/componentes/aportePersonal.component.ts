...
@Component({
  selector: 'app-aporte-personal',
  templateUrl: 'aportePersonal.html'
})
export class AportePersonalComponent extends BaseComponent implements OnInit, AfterViewInit {
  atencioncliente: any;
  ...
  constructor(router: Router, dtoServicios: DtoServicios, public route: ActivatedRoute, public appService: AppService) {
    super(router, dtoServicios, 'ABSTRACT', 'APORTEPERSONAL', false);
