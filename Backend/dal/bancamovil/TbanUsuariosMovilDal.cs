...
namespace dal.bancaenlinea
{
    ...
    /// </summary>
    public class TbanUsuariosMovilDal
    {

        private static string SQL_ULTIMOS_N = "SELECT DISTINCT fmodificacion, password from TbanUsuarios t where t.cusuario = @cusuario order by fmodificacion desc ";
