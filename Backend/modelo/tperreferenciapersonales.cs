...
namespace modelo
{
    ...
    public partial class tperreferenciapersonales: AbstractDto,IBean
    {
    public virtual object Clone() {
        ...
        public Nullable<int> ctipovinculacion { get; set; }
        public string identificacion { get; set; }
        public string genero { get; set; }
        public string nombre { get; set; }
        public Nullable<long> cpersonaconyugue { get; set; }
    ...
    [JsonIgnore]
    [IgnoreDataMember]
        public virtual tpertipovinculacion tpertipovinculacion { get; set; }
    }
}
