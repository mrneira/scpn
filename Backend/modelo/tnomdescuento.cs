...
namespace modelo
{
    ...
    public partial class tnomdescuento: AbstractDto,IBean
    {
    public virtual object Clone() {
    			return this.MemberwiseClone();
            }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tnomdescuento()
        {
        }
    
        public long cdescuento { get; set; }
        ...
        public Nullable<int> egresoccatalogo { get; set; }
        public string egresocdetalle { get; set; }
        public string nombre { get; set; }
        public Nullable<bool> porcentual { get; set; }
        public Nullable<decimal> valor { get; set; }
        public Nullable<bool> estado { get; set; }
        public string descripcion { get; set; }
        public Nullable<bool> asignacion { get; set; }
