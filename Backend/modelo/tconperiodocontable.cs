...
namespace modelo
{
    ...
    public partial class tconperiodocontable: AbstractDto,IBean
    {
    public virtual object Clone() {
    			return this.MemberwiseClone();
            }
        public int anio { get; set; }
        public int mesperiodoccatalogo { get; set; }
        public string mesperiodocdetalle { get; set; }
        public Nullable<bool> activo { get; set; }
        public int fperiodoini { get; set; }
        public int fperiodofin { get; set; }
