...
namespace modelo
{
    ...
    public partial class tpernatural: AbstractDto,IBean
    {
    public virtual object Clone() {
        ...
        public Nullable<int> estadocivilccatalogo { get; set; }
        public string estadocivilcdetalle { get; set; }
        public Nullable<int> nivelestudiosccatalogo { get; set; }
        public string nivelestudioscdetalle { get; set; }
        public Nullable<int> profesionccatalogo { get; set; }
        public string profesioncdetalle { get; set; }
    ...
    [JsonIgnore]
    [IgnoreDataMember]
        public virtual tgennacionalidad tgennacionalidad { get; set; }
    [JsonIgnore]
    [IgnoreDataMember]
