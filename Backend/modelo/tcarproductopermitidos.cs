...
namespace modelo
{
    ...
    public partial class tcarproductopermitidos: AbstractDto,IBean
    {
    public virtual object Clone() {
        ...
        public int cproductopermitido { get; set; }
        public int ctipoproductopermitido { get; set; }
    ...
    [JsonIgnore]
    [IgnoreDataMember]
        public virtual tcarproducto tcarproducto { get; set; }
    [JsonIgnore]
    [IgnoreDataMember]
