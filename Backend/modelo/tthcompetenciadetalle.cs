...
namespace modelo
{
    ...
    public partial class tthcompetenciadetalle: AbstractDto,IBean
    {
    public virtual object Clone() {
    			return this.MemberwiseClone();
            }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2214:DoNotCallOverridableMethodsInConstructors")]
        public tthcompetenciadetalle()
        {
        }
    
        public long ccompetenciadetalle { get; set; }
    ...
    [JsonIgnore]
    [IgnoreDataMember]
        public virtual tthcompetencia tthcompetencia { get; set; }
    }
}
