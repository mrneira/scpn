...
namespace modelo
{
    ...
    public partial class tinvjuntaaccionistas: AbstractDto,IBean
    {
    public virtual object Clone() {
    			return this.MemberwiseClone();
            }
        public long cinvjuntaaccionistas { get; set; }
        public Nullable<int> emisorccatalogo { get; set; }
        public string emisorcdetalle { get; set; }
        public Nullable<int> fjunta { get; set; }
        public Nullable<decimal> porcentajeefectivo { get; set; }
        public Nullable<decimal> porcentajeacciones { get; set; }
