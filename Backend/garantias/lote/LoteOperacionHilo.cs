...
namespace garantias.lote {
    /// <summary>
    /// Clase que se encarga de ejecutar una tareas por operacion. Lee las tareas definidas en la tabla TgarOperacionLote, para un numero de operacion y las ejecuta.
    /// </summary>
        ...
        public void Ejecutar()
        {
            ...
            using (var contextoTransaccion = contexto.Database.BeginTransaction()) {
                try {
                    ...
                    TareasOperacionGarantia.Ejecutar(rqm, rqoperacion);
