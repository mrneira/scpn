    ...
    public class InformacionSocios : ComponenteConsulta {
        ...
        public override void Ejecutar(RqConsulta rqconsulta)
        {
            ...
            Dictionary<string, object> mdatos = new Dictionary<string, object> {
                ...
                ["ntipocargo"] = TgenCatalogoDetalleDal.Find((int)socio.ccatalogotipocargo, socio.cdetalletipocargo).nombre,
                ["nestado"] = TgenCatalogoDetalleDal.Find((int)socio.ccatalogotipoestado, socio.ccdetalletipoestado).nombre,
