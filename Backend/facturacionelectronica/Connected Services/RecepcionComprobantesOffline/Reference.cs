...
namespace facturacionelectronica.RecepcionComprobantesOffline {
    ...
    public interface RecepcionComprobantesOffline {
        ...
        facturacionelectronica.RecepcionComprobantesOffline.validarComprobanteResponse validarComprobante(facturacionelectronica.RecepcionComprobantesOffline.validarComprobante request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<facturacionelectronica.RecepcionComprobantesOffline.validarComprobanteResponse> validarComprobanteAsync(facturacionelectronica.RecepcionComprobantesOffline.validarComprobante request);
    }
    ...
    public partial class validarComprobanteResponse {
        ...
        public facturacionelectronica.RecepcionComprobantesOffline.respuestaSolicitud RespuestaRecepcionComprobante;
        
        public validarComprobanteResponse() {
        }
        
        public validarComprobanteResponse(facturacionelectronica.RecepcionComprobantesOffline.respuestaSolicitud RespuestaRecepcionComprobante) {
            this.RespuestaRecepcionComprobante = RespuestaRecepcionComprobante;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface RecepcionComprobantesOfflineChannel : facturacionelectronica.RecepcionComprobantesOffline.RecepcionComprobantesOffline, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RecepcionComprobantesOfflineClient : System.ServiceModel.ClientBase<facturacionelectronica.RecepcionComprobantesOffline.RecepcionComprobantesOffline>, facturacionelectronica.RecepcionComprobantesOffline.RecepcionComprobantesOffline {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        facturacionelectronica.RecepcionComprobantesOffline.validarComprobanteResponse facturacionelectronica.RecepcionComprobantesOffline.RecepcionComprobantesOffline.validarComprobante(facturacionelectronica.RecepcionComprobantesOffline.validarComprobante request) {
            return base.Channel.validarComprobante(request);
        }
        
        public facturacionelectronica.RecepcionComprobantesOffline.respuestaSolicitud validarComprobante(byte[] xml) {
            facturacionelectronica.RecepcionComprobantesOffline.validarComprobante inValue = new facturacionelectronica.RecepcionComprobantesOffline.validarComprobante();
            inValue.xml = xml;
            facturacionelectronica.RecepcionComprobantesOffline.validarComprobanteResponse retVal = ((facturacionelectronica.RecepcionComprobantesOffline.RecepcionComprobantesOffline)(this)).validarComprobante(inValue);
            return retVal.RespuestaRecepcionComprobante;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<facturacionelectronica.RecepcionComprobantesOffline.validarComprobanteResponse> facturacionelectronica.RecepcionComprobantesOffline.RecepcionComprobantesOffline.validarComprobanteAsync(facturacionelectronica.RecepcionComprobantesOffline.validarComprobante request) {
            return base.Channel.validarComprobanteAsync(request);
        }
        
        public System.Threading.Tasks.Task<facturacionelectronica.RecepcionComprobantesOffline.validarComprobanteResponse> validarComprobanteAsync(byte[] xml) {
            facturacionelectronica.RecepcionComprobantesOffline.validarComprobante inValue = new facturacionelectronica.RecepcionComprobantesOffline.validarComprobante();
            inValue.xml = xml;
            return ((facturacionelectronica.RecepcionComprobantesOffline.RecepcionComprobantesOffline)(this)).validarComprobanteAsync(inValue);
        }
    }
}
