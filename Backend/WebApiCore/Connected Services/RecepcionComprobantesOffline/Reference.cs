...
namespace WebApiCore.RecepcionComprobantesOffline {
    ...
    public interface RecepcionComprobantesOffline {
        ...
        WebApiCore.RecepcionComprobantesOffline.validarComprobanteResponse validarComprobante(WebApiCore.RecepcionComprobantesOffline.validarComprobante request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<WebApiCore.RecepcionComprobantesOffline.validarComprobanteResponse> validarComprobanteAsync(WebApiCore.RecepcionComprobantesOffline.validarComprobante request);
    }
    ...
    public partial class validarComprobanteResponse {
        ...
        public WebApiCore.RecepcionComprobantesOffline.respuestaSolicitud RespuestaRecepcionComprobante;
        
        public validarComprobanteResponse() {
        }
        
        public validarComprobanteResponse(WebApiCore.RecepcionComprobantesOffline.respuestaSolicitud RespuestaRecepcionComprobante) {
            this.RespuestaRecepcionComprobante = RespuestaRecepcionComprobante;
        }
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface RecepcionComprobantesOfflineChannel : WebApiCore.RecepcionComprobantesOffline.RecepcionComprobantesOffline, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class RecepcionComprobantesOfflineClient : System.ServiceModel.ClientBase<WebApiCore.RecepcionComprobantesOffline.RecepcionComprobantesOffline>, WebApiCore.RecepcionComprobantesOffline.RecepcionComprobantesOffline {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        WebApiCore.RecepcionComprobantesOffline.validarComprobanteResponse WebApiCore.RecepcionComprobantesOffline.RecepcionComprobantesOffline.validarComprobante(WebApiCore.RecepcionComprobantesOffline.validarComprobante request) {
            return base.Channel.validarComprobante(request);
        }
        
        public WebApiCore.RecepcionComprobantesOffline.respuestaSolicitud validarComprobante(byte[] xml) {
            WebApiCore.RecepcionComprobantesOffline.validarComprobante inValue = new WebApiCore.RecepcionComprobantesOffline.validarComprobante();
            inValue.xml = xml;
            WebApiCore.RecepcionComprobantesOffline.validarComprobanteResponse retVal = ((WebApiCore.RecepcionComprobantesOffline.RecepcionComprobantesOffline)(this)).validarComprobante(inValue);
            return retVal.RespuestaRecepcionComprobante;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<WebApiCore.RecepcionComprobantesOffline.validarComprobanteResponse> WebApiCore.RecepcionComprobantesOffline.RecepcionComprobantesOffline.validarComprobanteAsync(WebApiCore.RecepcionComprobantesOffline.validarComprobante request) {
            return base.Channel.validarComprobanteAsync(request);
        }
        
        public System.Threading.Tasks.Task<WebApiCore.RecepcionComprobantesOffline.validarComprobanteResponse> validarComprobanteAsync(byte[] xml) {
            WebApiCore.RecepcionComprobantesOffline.validarComprobante inValue = new WebApiCore.RecepcionComprobantesOffline.validarComprobante();
            inValue.xml = xml;
            return ((WebApiCore.RecepcionComprobantesOffline.RecepcionComprobantesOffline)(this)).validarComprobanteAsync(inValue);
        }
    }
}
