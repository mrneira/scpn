...
{
    class BuzonPolizaNueva : ComponenteMantenimiento
    {
        ...
        public override void Ejecutar(RqMantenimiento rqmantenimiento)
        {
            ...
            if (rqmantenimiento.GetTabla("BUZONPOLIZASNUEVAS") == null)
            { return; }

            poliza = rqmantenimiento.GetTabla("BUZONPOLIZASNUEVAS").Lregistros;


            List<IBean> poliEliminar = new List<IBean>();
            

                poliEliminar = rqmantenimiento.GetTabla("BUZONPOLIZASNUEVAS").Lregeliminar;
                ...
                if (accion.Equals("eliminar"))
                {
                    foreach (tsgspoliza polEli in poliEliminar)
                    {
                        ...
                        rqmantenimiento.Mtablas["BUZONPOLIZASNUEVAS"] = null;
