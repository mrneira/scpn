...
namespace contabilidad.comp.mantenimiento.cuentasporcobrar.facturasparqueaderocontrato {
    ...
    public class ContabilizarFPC : ComponenteMantenimiento {
        ...
        public override void Ejecutar(RqMantenimiento rqmantenimiento)
        {
            ...
            try
            {
                ...
                tconparametros plantilla_fp = TconParametrosDal.FindXCodigo("PLANTILLA_CONTABLE_FAC_PARQ_CONTRATO", rqmantenimiento.Ccompania);
                if (plantilla_fp == null) {
                    throw new AtlasException("CONTA-010", "ERROR: PARAMETROS CONTABLE [{0}] NO DEFINIDO PARA MODULO CONTABILIDAD", "PLANTILLA_CONTABLE_FAC_PARQ_CONTRATO");
                }
                ...
                Comprobante.CompletarAutorizacion(rqmantenimiento, cxc, "DIAGEN", comprobante,null);
            }
            catch (Exception e)
            {
                throw new AtlasException("CONTA-010", "ERROR: PARAMETROS CONTABLE [{0}] NO DEFINIDO PARA MODULO CONTABILIDAD", "PLANTILLA_CONTABLE_FAC_PARQ_CONTRATO");
