...
{
    public class RecalcularDecimos : ComponenteMantenimiento
    {
        /// <summary>
        ...
        public override void Ejecutar(RqMantenimiento rm)
        {
            ...
            IList<Decimos> rolPagosGenerados = new List<Decimos>();
            ...
            foreach (tnomrol ls in rolPagos)
            {
                ...
                rolPago = new Decimos(lnom.finicio.Value, lnom.ffin.Value, rm.Ccompania, lnom.cnomina, (long)lnom.anio, lnom.mescdetalle, cd, param, pdecimo, tnd, lnom.tipocdetalle);
                //DATOS
                rolPago.setDetalles();
                //CALCULOS GENERALES
