...
namespace WebApiExt.Controllers {
    /*
    /// <summary>
    /// Controlador que maneja las peticiones del proyecto "atlasng_ban" usado para la banca en linea, redirecciona la peticion 
    /// al proyecto WebApiCore->ExtController
    /// </summary>
    [PoliticaCorsBan]
    [RoutePrefix("atlas-ext-ban/servicioRest")]
