...
namespace canalesdigitales.comp.mantenimiento.mails {
    internal class MailCertificado : ComponenteMantenimiento {
        ...
        public override void Ejecutar(RqMantenimiento rqmantenimiento) {
            ...
            parametrosmail.Add("certificado", rqmantenimiento.GetString("certificado"));
            ...
            rqmantenimiento.AddDatos("cnotificacion", 34);
