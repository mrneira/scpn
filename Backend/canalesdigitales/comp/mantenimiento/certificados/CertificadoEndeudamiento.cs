...
namespace canalesdigitales.comp.mantenimiento.certificados {
    class CertificadoEndeudamiento : ComponenteMantenimiento {

        private readonly ComponenteHelper componenteHelper = new ComponenteHelper();

        public override void Ejecutar(RqMantenimiento rqmantenimiento) {
            ConsultarSaldosVencidos(rqmantenimiento);
        }

        private void ConsultarSaldosVencidos(RqMantenimiento rqmantenimiento) {
        ...
        private void GenerarCertificado(RqMantenimiento rqmantenimiento, long cpersona, List<Dictionary<string, object>> lsaldosoperaciones) {
            ...
            string tituloReporte = "Certificado de Endeudamiento";
            string nombreAdjunto = "Certificado_Endeudamiento";
            ...
            parametros.Add("archivoReporteUrl", "/CesantiaReportes/BancaEnLinea/ReporteCertificado");
