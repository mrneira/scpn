...
{
    /// <summary>
    /// Clase que se encarga de ejecutar tareas de operaciones de cartera. La ejecucion de tareas se realiza en un hilo por cada operacion, y
    /// maneja una transaccion de base de datos independiente.
    /// </summary>
    public class TareasCartera : TareasModulo {
        ...
        public override void Procesar(RqMantenimiento rqmantenimiento, RequestModulo rqmodulo, int? numerohilos) {
		    try {
                ...
                rSet = TcarOperacionLoteDal.LlenaResultset(rqmodulo.Fconatble, rqmodulo.Clote, rqmodulo.Cmodulo, rqmodulo.Ctareahorizontal);
