...
namespace seguridad.comp.mantenimiento.blinea.login {
    ...
    public class ActivaSesion : ComponenteMantenimiento {
        ...
        public override void Ejecutar(RqMantenimiento rqmantenimiento) {
            ...
            tbanusuariosession tsegUsuarioSession = (tbanusuariosession)rqmantenimiento.GetDatos("TBANUSUARIOSESSION");
            ...
            TbanUsuarioSessionHistoriaDal.Crearhistoria(tsegUsuarioSession);
        }
